...
Для слияния веток сначалf перейдите в основную ветку (master) при помощи команды *git checkout master*, затем используйте команду *git merge <название ветки, которую хотите присоединить>*
